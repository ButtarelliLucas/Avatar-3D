...
function setupScene(gltf) {
    ...
    const waveClip = THREE.AnimationClip.findByName(clips, 'Saludo');
    const stumbleClip = THREE.AnimationClip.findByName(clips, 'Tropiezo');
    ...
    controls.addEventListener('change', () => {
      // Aquí puedes colocar la lógica para cambiar la animación
      if (!isStumbling) {
        isStumbling = true;
        stumbleAction.reset();
        stumbleAction.play();
